...
export default function Home() {
  return (
    <>
      <main className={"bg-primary px-6 lg:px-0 text-center py-20 lg:py-36"} style={{backgroundImage: "url('/trees.svg')", backgroundPosition: "bottom", backgroundSize: "cover"}}>
          <h2 className={"text-[#D1D6D5] mb-4 font-semibold"}>SOUTENIR LES SCIENTIFIQUES ET COMBATTRE LA DÉSINFORMATION</h2>
          <div className={"text-white text-4xl lg:text-5xl font-bold mb-4 max-w-3xl mx-auto"}>Les menaces aux scientifiques vous choquent ? Nous aussi.</div>
          ...
          <div className={"inline-flex flex-col lg:flex-row gap-4 mt-16 mx-auto"}>
        ...
        <section id={"le-constat"} className={"py-20 lg:py-36 px-6 lg:px-0 max-w-7xl mx-auto"}>
            ...
            <div className={"bg-light-200 flex flex-col lg:flex-row justify-between gap-3 lg:gap-6 rounded-lg mb-8"}>
                ...
                <Image className={"lg:-translate-y-4 inline-block object-contain z-20 bg-white rounded-lg border"} src={"/tweet.png"} width={578} height={284} alt={"Tweet agression sur Twitter/X sur un scientifique"}/>
            </div>
            <div className={"bg-primary rounded-lg p-8 lg:p-20 text-center relative"}>
                <h2 className={"text-[#CCD2D1] mb-4 font-semibold uppercase"}>Une majorité de soutiens silencieux</h2>
                <div className={"text-3xl lg:text-4xl text-white font-bold mb-4 max-w-5xl mx-auto"}>Il est temps que la majorité de silencieuse se fasse entendre pour apporter un soutien aux scientifiques afin de contrer la violence et la désinformation sur internet.</div>
                <div className={"inline-flex flex-col lg:flex-row gap-4 mt-10 mx-auto"}>
                ...
                <Image className={"absolute -bottom-4 z-20 -right-16 h-16 lg:h-52"} src={"/BigFlag.svg"} width={254} height={304} alt={"Gros logo drapeau"}/>
            </div>
        </section>
        <section id={"le-projet"} className={"bg-primary px-6 lg:px-0"} style={{backgroundImage: "url('/trees2.svg')", backgroundPosition: "bottom", backgroundSize: "cover"}}>
            <div className={"max-w-7xl mx-auto py-20 flex flex-col lg:flex-row justify-between items-center gap-12"}>
                <div className={""}>
                    <h2 className={"text-white mb-4 font-semibold uppercase"}>Le PROJET</h2>
                    <div className={"text-4xl lg:text-5xl text-white font-bold mb-4 max-w-3xl"}>Climalliés fédère une communauté de soutient aux scientifiques </div>
        ...
        <section className={"bg-secondary-300 px-6 lg:px-0"}>
            <div className={"max-w-7xl mx-auto py-20 flex gap-8"}>
                <div>
                    <h2 className={"mb-4 font-semibold uppercase"}>Le KIT ANTI-DÉSINFORMATION</h2>
                    <div className={"text-4xl lg:text-5xl font-bold mb-4 max-w-2xl"}>Un kit pour savoir répondre aux arguments fallacieux, malhonnêtes ou erronés</div>
